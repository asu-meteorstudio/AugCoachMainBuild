...
namespace com.rfilkov.kinect
{
    ...
    public class Kinect4AzureInterface : DepthSensorBase
    {
        ...
        public long pauseTimeElapsed = 0;
        ...
        public void Pause(bool isPaused) //LG
        {
            if (isPaused)
            {
                deviceStreamingMode = KinectInterop.DeviceStreamingMode.PauseRecording;
                pauseTimeElapsed = DateTime.Now.Ticks - playbackStartTime;

            }
            else
            {
                deviceStreamingMode = KinectInterop.DeviceStreamingMode.PlayRecording;
                playbackStartTime = DateTime.Now.Ticks - pauseTimeElapsed;
            }
        }
        ...
        public override void PollSensorFrames(KinectInterop.SensorData sensorData)
        {
            try
            {
                if (kinectPlayback != null)
                {
                    if (deviceStreamingMode == KinectInterop.DeviceStreamingMode.PauseRecording) //LG
                    {
                        print("paused");
                        return;
                    }
